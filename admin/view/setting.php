...
function koala_wechat_x_setting_save() {
	...
	if ( sanitize_text_field( $_POST['submit'] ) ) {
		...
		if ( sanitize_text_field( $_POST[ koala_wechat_x_official_account_code ] ) ) {
		...
		if ( $updated ) {
			...
			echo '<div id="message" class="notice notice-success is-dismissible"><p>设置保存失败!</p></div>';//保存完毕显示文字提示
		}
	} //if
    ...
    <div class="wrap">
        ...
        <form method="post" novalidate="novalidate" enctype="multipart/form-data">
            <table class="form-table" role="presentation">
                ...
                <tr>
                    <th scope="row">
                        <label for="<?php echo koala_wechat_x_official_account_name ?>">公众号名称</label>
                    </th>
                    <td>
                        <input name="<?php echo koala_wechat_x_official_account_name ?>" type="text"
                               id="<?php echo koala_wechat_x_official_account_name ?>"
                               value="<?php echo get_option( koala_wechat_x_official_account_name ) ?>"
                               class="regular-text">
                    </td>
                </tr>
